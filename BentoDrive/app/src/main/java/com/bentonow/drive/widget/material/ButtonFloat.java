...
public class ButtonFloat extends Button{
	...
	public ButtonFloat(Context context, AttributeSet attrs) {
		...
		RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(AndroidUtil.dpToPx(sizeIcon, getResources()), AndroidUtil.dpToPx(sizeIcon, getResources()));
	...
	protected void setDefaultProperties(){
		rippleSpeed = AndroidUtil.dpToPx(2, getResources());
		rippleSize = AndroidUtil.dpToPx(5, getResources());
	...
	protected void setAttributes(AttributeSet attrs){
		...
		if(animate){
			post(new Runnable() {
				...
				@Override
				public void run() {
					float originalY = ViewHelper.getY(ButtonFloat.this)-AndroidUtil.dpToPx(24, getResources());
	...
	protected void onDraw(Canvas canvas) {
		...
		if (x != -1) {
			...
			Rect dst = new Rect(AndroidUtil.dpToPx(1, getResources()), AndroidUtil.dpToPx(2, getResources()), getWidth()-AndroidUtil.dpToPx(1, getResources()), getHeight()-AndroidUtil.dpToPx(2, getResources()));
